...
class UI_MainWindow(object):
    """
    Main Window UI class used to set up the main window UI.
    
    """
    def __init__(self, base_path: str = None) -> None:
        """
        Initialize the UI_MainWindow class.

        Args:
            base_path (str, optional): The base path for the application. Defaults to None.
        """
    ...
    def setup_ui(self, parent: QMainWindow) -> None:
        ...
        if self.settings["language"] == "eng":
            toggle_text = "Menu"
            toogle_tooltip = "Toggle Menu"
        elif self.settings["language"] == "de":
            toggle_text = "Menü einklappen"
            toogle_tooltip = "Menü ausklappen"
        ...
        self.title_bar = PyTitleBar(
            ...
            logo_width = 100,
            app_parent = self.central_widget,
            logo_image = "ai_logo_title_bar.png",
        ...
        self.title_bar.title_label.setText("Main Window")
        ...
        self.load_pages = Ui_MainPages(ui_object=self)
        self.load_pages.setupUi(self.content_area_left_frame, self.base_path)
