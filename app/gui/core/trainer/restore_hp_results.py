...
result_path = os.path.join(os.getcwd(), 'hp_param_tune', 'train_mask_r_cnn')
tuner = Tuner.restore(result_path, trainable=train_model)
...
df = result_grid.get_dataframe(filter_metric="accuracy", filter_mode="max") 
print(f"df: {df}")