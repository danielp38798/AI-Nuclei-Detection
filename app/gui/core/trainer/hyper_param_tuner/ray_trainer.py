...
class RayTrainer(object):
    """
    Trainer class for Mask R-CNN model for hyper parameter tuning with Ray Tune
    takes a config dict as input and sets up the model, data loaders, optimizer, learning rate scheduler, and TensorBoard
    ...
    def __init__(self, config):
        ...
        self.metric_logging_dir = os.path.join(os.getcwd(), "ray_tune_metric_logging")
