...
class MaskRCNNTrainable(tune.Trainable):
    ...
    def setup(self, config: dict):
        ...
        self.root_dir = r"/home/pod44433/Mask_R_CNN/AI_nuclei_detection/GUI/train_data"
    ...
    def load_data(self):
        ...
        print("Checkpoint directory: {}".format(self.ckpt_dir))
...
def run_hyperparam_tune(num_samples):
    ...
    hp_param_space = {
        ...
        "batch_size": tune.choice([6]), #tune.choice([2, 4, 8, 16]),
    ...
    #trainable_with_resources = tune.with_resources(MaskRCNNTrainable, {"cpu": 2, "gpu": 1})
    tuner = tune.Tuner(trainable=MaskRCNNTrainable,
    ...
    best_result_min_loss = result_grid.get_best_result(metric="val_loss", mode="min")
    ...
    df = result_grid.get_dataframe(filter_metric="val_loss", filter_mode="min") 
    print(f"df: {df}")
