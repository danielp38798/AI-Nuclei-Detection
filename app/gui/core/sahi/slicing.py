...
from  gui.core.sahi.annotation import BoundingBox, Mask
from  gui.core.sahi.utils.coco import Coco, CocoAnnotation, CocoImage, create_coco_dict
from  gui.core.sahi.utils.cv import IMAGE_EXTENSIONS_LOSSLESS, IMAGE_EXTENSIONS_LOSSY, read_image_as_pil
from  gui.core.sahi.utils.file import load_json, save_json
...
def process_coco_annotations(
    ...
    for coco_annotation in coco_annotation_list:
        if len(coco_annotation.json["bbox"])== 0:
            continue
