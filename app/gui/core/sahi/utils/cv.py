...
def visualize_object_predictions(
    ...
    # store color and category name for each object prediction
    color_dict = {}
    category_name_dict = {}
    for object_prediction in object_prediction_list:
        category_id = object_prediction.category.id
        category_name = object_prediction.category.name
        color = colors(category_id) # rgb tuple
        #color = (0, 255, 0)
        color_dict[category_id] = color
        category_name_dict[category_id] = category_name
    ...
    return {"image": image,
            ...
            "category_name_dict": category_name_dict}
