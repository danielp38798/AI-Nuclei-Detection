...
from gui.core.sahi.utils.shapely import ShapelyAnnotation
...
class Mask:
    ...
    def export_bool_mask(self, path):
        """
        stores the bool mask as jpeg in given path
        """
        import cv2
        cv2.imwrite(path, self.bool_mask.astype(np.uint8)*255)
