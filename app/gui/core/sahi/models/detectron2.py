...
from gui.core.sahi.utils.cv import get_bbox_from_bool_mask
...
class Detectron2DetectionModel(DetectionModel):
    def check_dependencies(self):
        check_requirements(["torch"]) #, "gui.core.detection_module.detectron2"])
    ...
    def load_model(self):
        ...
        from gui.core.detection_module.detectron2.model_zoo import model_zoo
    ...
    def _create_object_prediction_list_from_original_predictions(
        ...
        if masks is not None:
            object_prediction_list = [
                ObjectPrediction(
                    ...
                    category_id=category_id.item()+1, # +1 to match the category id of coco dataset
                    category_name=self.category_mapping[str(category_id.item()+1)],
        ...
        del original_predictions, object_prediction_list, object_prediction_list_per_image
