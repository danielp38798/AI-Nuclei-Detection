...
class TorchVisionDetectionModel(DetectionModel):
    ...
    def load_model(self):
        ...
        from  gui.core.sahi.utils.torchvision import MODEL_NAME_TO_CONSTRUCTOR
    ...
    def set_model(self, model: Any):
        ...
        from  gui.core.sahi.utils.torchvision import COCO_CLASSES
    ...
    def perform_inference(self, image: np.ndarray, image_size: int = None):
        ...
        """
        from  gui.core.sahi.utils.torch import to_float_tensor
    ...
    def _create_object_prediction_list_from_original_predictions(
        ...
        for image_predictions in original_predictions:
            ...
            #print(f"amount of masks: {len(masks)}")
            ...
            for ind in range(len(boxes)):
                if masks is not None:
                    ...
                    # if numpy array is empty, set mask to None
                    if mask.size == 0:
                        mask = None
                    else:
                        # convert mask to bool
                        mask = mask.squeeze(axis=0) > 0.5
                        #print(f"mask: {mask}")
