...
import json
#from cellpose import models --> temporarily removed Trainer page
#from manage_coco_datasets import merge_from_dir, split_from_file
from gui.core.nuclei_annotation_toolbox.manage_coco_datasets import merge_from_dir, split_from_file
...
class NucleiAnnotationToolbox(QWidget):
    def __init__(self):
        super().__init__()
        self.init_ui()
        center_window(self)
