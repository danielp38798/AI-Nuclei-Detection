...
from gui.core.detection_module.detectron2.data import DatasetCatalog, MetadataCatalog
from gui.core.detection_module.detectron2.utils.comm import all_gather, is_main_process, synchronize
