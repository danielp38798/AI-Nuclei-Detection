...
from gui.core.detection_module.detectron2.layers import Conv2d, ConvTranspose2d, cat, interpolate
from gui.core.detection_module.detectron2.structures import Instances, heatmaps_to_keypoints
