...
from gui.core.detection_module.detectron2.layers import ShapeSpec
from gui.core.detection_module.detectron2.structures import Boxes, Instances, pairwise_iou
