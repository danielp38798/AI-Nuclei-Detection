...
from gui.core.detection_module.detectron2.layers import ShapeSpec, batched_nms
from gui.core.detection_module.detectron2.structures import Boxes, ImageList, Instances, pairwise_point_box_distance
