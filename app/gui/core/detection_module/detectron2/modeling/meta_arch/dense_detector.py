...
from gui.core.detection_module.detectron2.modeling import Backbone
from gui.core.detection_module.detectron2.structures import Boxes, ImageList, Instances
