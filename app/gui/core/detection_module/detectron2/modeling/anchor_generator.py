...
from gui.core.detection_module.detectron2.layers import ShapeSpec, move_device_like
from gui.core.detection_module.detectron2.structures import Boxes, RotatedBoxes
