...
def slice_coco(
    ...
    if output_coco_annotation_file_name and output_dir:
        ...
        # save json in the parent folder of the output_dir
        parent_folder = Path(output_dir).parent
        save_path = parent_folder / "annotations" / (output_coco_annotation_file_name + ".json")
